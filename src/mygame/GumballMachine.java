...
public class GumballMachine {
    ...
    private void initKeys() {
        ...
        Main.app.getInputManager().addMapping("Quarter", new KeyTrigger(KeyInput.KEY_3));
        Main.app.getInputManager().addMapping("FakeQuarter", new KeyTrigger(KeyInput.KEY_4));
        Main.app.getInputManager().addMapping("TurnCrank", new KeyTrigger(KeyInput.KEY_SPACE));
        // Add the names to the action listener.
        Main.app.getInputManager().addListener(actionListener, "Nickle", "Dime", "Quarter", "FakeQuarter", "TurnCrank");
